...
?>
    ...
    <body>
        <div class="flex items-center justify-center h-screen bg-gradient-to-r from-pink-500 via-rose-500 to-orange-400">
            <form class="w-1/3 bg-white rounded-lg shadow p-8 space-y-6" action="?mod=restaurant&act=update&id=<?php echo $id ?>" method="post">
                <input type="hidden" name="user" value="<?php echo $user_id ?>">
                <h1 class="text-center text-4xl font-bold leading-9 tracking-tight text-gray-900 mb-16">Edit Restaurant</h1>
                <div class="input-field">
                    <div class="relative">
                        <input type="text" name="id" id="id" class="block focus:border-rose-500 border-2 px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-rose-500 peer" placeholder=" " value="<?php echo $input['id'] ?? ''; ?>" disabled>
                        <label for="id" class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-[0.8] top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-rose-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-[0.8] peer-focus:-translate-y-4 left-1">Restaurant ID</label>
                    </div>
                ...
                <div class="input-field">
                    <div class="relative">
                        <input type="text" name="img_url" id="img_url" onchange="handleImgChange()" class="block focus:border-rose-500 border-2 px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-rose-500 peer" placeholder=" " value="<?php echo $input['img_url'] ?? ''; ?>">
                ...
                <div class="input-field flex justify-center">
                    <img src="<?php echo $image_url ?>" class="rounded-lg" id="img"/>
                </div>
                <div class="flex justify-around">
                    <button class="rounded bg-blue-500 text-white px-6 py-2" type="submit">Update</button>
